...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1668tryReceivePtdJZtk = receiveChannel.mo1668tryReceivePtdJZtk();
            if (ChannelResult.m1684isSuccessimpl(objMo1668tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1680getOrThrowimpl(objMo1668tryReceivePtdJZtk);
            }
            Throwable thM1678exceptionOrNullimpl = ChannelResult.m1678exceptionOrNullimpl(objMo1668tryReceivePtdJZtk);
            if (thM1678exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1678exceptionOrNullimpl);
        }
