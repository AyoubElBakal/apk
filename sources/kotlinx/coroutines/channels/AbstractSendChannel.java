    ...
    */
    ...
    public final Object mo1669trySendJP2dKIU(E element) {
        ...
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1687closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                ...
                objM1706constructorimpl$default = InlineList.m1711plusFjFbRPM(objM1706constructorimpl$default, receive);
            }
        }
        if (objM1706constructorimpl$default != null) {
            if (!(objM1706constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1706constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1706constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1706constructorimpl$default;
