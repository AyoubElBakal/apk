...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1684isSuccessimpl(objMo1669trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1678exceptionOrNullimpl = ChannelResult.m1678exceptionOrNullimpl(objMo1669trySendJP2dKIU);
