...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    ...
    public final Object mo1668tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        return objPollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1688failurePtdJZtk() : objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1687closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1689successJP2dKIU(objPollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM1706constructorimpl$default = InlineList.m1706constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1714remove()) {
                    ...
                    objM1706constructorimpl$default = InlineList.m1711plusFjFbRPM(objM1706constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1666onCancelIdempotentListww6eGU(objM1706constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                ChannelResult channelResultM1674boximpl = ChannelResult.m1674boximpl(ChannelResult.INSTANCE.m1687closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m163constructorimpl(channelResultM1674boximpl));
            }
        }
