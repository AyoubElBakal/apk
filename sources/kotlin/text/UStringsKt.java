...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m259constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m259constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM259constructorimpl = UInt.m259constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM259constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM259constructorimpl2 = UInt.m259constructorimpl(i3 * iM259constructorimpl);
            int iM259constructorimpl3 = UInt.m259constructorimpl(UInt.m259constructorimpl(iDigitOf) + iM259constructorimpl2);
            if (Integer.compare(iM259constructorimpl3 ^ Integer.MIN_VALUE, iM259constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM259constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM338constructorimpl = ULong.m338constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM338constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM338constructorimpl2 = ULong.m338constructorimpl(j * jM338constructorimpl);
            long jM338constructorimpl3 = ULong.m338constructorimpl(ULong.m338constructorimpl(((long) UInt.m259constructorimpl(iDigitOf)) & 4294967295L) + jM338constructorimpl2);
            if (Long.compare(jM338constructorimpl3 ^ Long.MIN_VALUE, jM338constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM338constructorimpl3;
        }
