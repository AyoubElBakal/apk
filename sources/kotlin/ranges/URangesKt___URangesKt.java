...
public class URangesKt___URangesKt {
    ...
    public static final boolean m1433containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1412containsVKZWuLQ(ULong.m338constructorimpl(((long) b) & 255));
    }
    ...
    public static final boolean m1432containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1412containsVKZWuLQ(ULong.m338constructorimpl(((long) i) & 4294967295L));
    }
    ...
    public static final boolean m1437containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1412containsVKZWuLQ(ULong.m338constructorimpl(((long) s) & 65535));
    }
    ...
    public static final UIntProgression step(UIntProgression uIntProgression, int i) {
        ...
        int iM1398getFirstpVg5ArA = uIntProgression.getFirst();
        int iM1399getLastpVg5ArA = uIntProgression.getLast();
        if (uIntProgression.getStep() <= 0) {
            i = -i;
        }
        return companion.m1400fromClosedRangeNkh28Cs(iM1398getFirstpVg5ArA, iM1399getLastpVg5ArA, i);
    }
    ...
    public static final ULongProgression step(ULongProgression uLongProgression, long j) {
        ...
        long jM1407getFirstsVKNKU = uLongProgression.getFirst();
        long jM1408getLastsVKNKU = uLongProgression.getLast();
        if (uLongProgression.getStep() <= 0) {
            j = -j;
        }
        return companion.m1409fromClosedRange7ftBX0g(jM1407getFirstsVKNKU, jM1408getLastsVKNKU, j);
    }
    ...
    public static final UIntRange m1443untilJ1ME1BU(int i, int i2) {
        return Integer.compare(i2 ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m259constructorimpl(i2 - 1), null);
    }
    ...
    public static final ULongRange m1445untileb3DHEI(long j, long j2) {
        return Long.compare(j2 ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m338constructorimpl(j2 - ULong.m338constructorimpl(((long) 1) & 4294967295L)), null);
    }
