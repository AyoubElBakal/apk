...
public final class UnsignedKt {
    ...
    public static final long m517ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m338constructorimpl(0L) : ULong.m338constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m338constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m338constructorimpl(j3 + ((long) (Long.compare(ULong.m338constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m338constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }
    ...
    public static final long m518ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m338constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m338constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m338constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m338constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
