...
public final class LongSaturatedMathKt {
    ...
    public static final long m1618saturatingAddpTJri5U(long j, long j2) {
        long jM1510getInWholeNanosecondsimpl = Duration.m1510getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1617checkInfiniteSumDefinedPjuGub4(j, j2, jM1510getInWholeNanosecondsimpl);
        }
        if ((1 | (jM1510getInWholeNanosecondsimpl - 1)) == Long.MAX_VALUE) {
            return m1619saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + jM1510getInWholeNanosecondsimpl;
        return ((j ^ j3) & (jM1510getInWholeNanosecondsimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }
    ...
    private static final long m1619saturatingAddInHalvespTJri5U(long j, long j2) {
        long jM1493divUwyO8pc = Duration.m1493divUwyO8pc(j2, 2);
        if (((Duration.m1510getInWholeNanosecondsimpl(jM1493divUwyO8pc) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (j + Duration.m1533toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m1618saturatingAddpTJri5U(m1618saturatingAddpTJri5U(j, jM1493divUwyO8pc), Duration.m1525minusLRDsOJo(j2, jM1493divUwyO8pc));
    }
