...
public final class DurationKt {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1592getZEROUwyO8pc = Duration.INSTANCE.m1592getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str2.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        z4 = z7;
                        long jM1526plusLRDsOJo = Duration.m1526plusLRDsOJo(jM1592getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1592getZEROUwyO8pc = Duration.m1526plusLRDsOJo(jM1526plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        jM1592getZEROUwyO8pc = Duration.m1526plusLRDsOJo(jM1592getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1592getZEROUwyO8pc = Duration.INSTANCE.m1590getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1526plusLRDsOJo2 = Duration.m1526plusLRDsOJo(jM1592getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1592getZEROUwyO8pc = Duration.m1526plusLRDsOJo(jM1526plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1592getZEROUwyO8pc = Duration.m1526plusLRDsOJo(jM1592getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1542unaryMinusUwyO8pc(jM1592getZEROUwyO8pc) : jM1592getZEROUwyO8pc;
    }
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1490constructorimpl((j << 1) + ((long) i));
    }
