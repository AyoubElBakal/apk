...
public class Carousel extends MotionHelper {
        ...
        if (i4 != -1 && i4 != this.mIndex) {
            this.mMotionLayout.post(new Runnable() { // from class: androidx.constraintlayout.helper.widget.Carousel$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m12lambda$updateItems$0$androidxconstraintlayouthelperwidgetCarousel();
                }
            });
    ...
    /* synthetic */ void m12lambda$updateItems$0$androidxconstraintlayouthelperwidgetCarousel() {
